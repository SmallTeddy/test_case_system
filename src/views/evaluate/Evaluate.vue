<template>
  <div class="evaluate">
    <el-card>
      <page-table v-loading="loading" :data="tableData" :currenPage="currenPage" :pageSize="pageSize" :pageTotal="pageTotal" @page-change="pageChange" @size-change="sizeChange">
...
import { TablePageTableMixins } from '@/mixins/TablePageTableMixins';

@Component({ mixins: [TablePageTableMixins] })
